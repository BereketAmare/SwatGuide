...
class User(db.Model):
    ...
    username = db.Column(db.String(30), nullable=False)  # Unique username unique=True,
...
class Guide(db.Model):
    ...
    liked_by = db.relationship('User', secondary=likes, backref=db.backref('liked_guides', lazy='dynamic'))
    comments = db.relationship('Comment', backref='guide', cascade="all, delete-orphan", lazy=True)
